...
struct SettingsView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Design.Space.lg) {
                ...
                GroupBox("Groups, pinned items, and snippets") {
                ...
                GroupBox("Paste and integrations") {
    ...
    private var header: some View { VStack(alignment: .leading, spacing: 4) { Text("PasteX Settings").font(.system(size: 20, weight: .semibold)); Text("Local-first clipboard controls. Changes apply immediately unless noted.").font(.system(size: 12)).foregroundStyle(Design.Color.muted) } }
